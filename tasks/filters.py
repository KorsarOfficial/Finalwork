...
class TaskFilter(django_filters.FilterSet):
    """
    Фильтр для задач.
    Позволяет фильтровать задачи по различным параметрам, таким как имя, статус, назначенный сотрудник, приоритет и срок выполнения.
    """
    ...
    class Meta:
        ...
        Определяют модель, для которой создается фильтр, и список полей, по которым можно фильтровать.
        """
